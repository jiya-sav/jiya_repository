...
title: Unit 3 Sections 3-4 Classwork
toc: true
comments: true
categories: [week 13]
...
the symbol for subtraction is </strong></strong>  : -
the symbol for multiplication is <em>__</em>  : </em>
the symbol for division is <strong><strong>  : /
the symbol for modulus is </strong></strong> : %
an algorithm is ___ : a sequence of steps that performs a specific task</p>
...
Concatenation is <strong>__</strong>  : combing two strings
Length is <strong><strong> : how many characters are in a string 
A substring is ___</strong></strong>  : part of a string</p>
...
<span class="n">string3</span> <span class="o">=</span> <span class="n">string1</span> <span class="o">+</span> <span class="s2">&quot; &quot;</span> <span class="o">+</span> <span class="n">string2</span> <span class="c1"># added a space in between</span>
...
<span class="k">def</span> <span class="nf">length</span><span class="p">(</span><span class="nb">list</span><span class="p">):</span>
    <span class="k">for</span> <span class="n">n</span> <span class="ow">in</span> <span class="n">names</span><span class="p">:</span>
        ...
        <span class="nb">print</span><span class="p">(</span><span class="nb">len</span><span class="p">(</span><span class="n">n</span><span class="p">))</span>
