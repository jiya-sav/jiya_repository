...
<ul>
<li>The typical time complexity of a hashtable is O1. </li>
</ul>
...
<span class="c1"># the output only includes one of each value; duplicates are not printed.</span>
<span class="c1"># outputs are also in numerical order, and order of which numbers were put in first</span>

<span class="c1"># Why do you think Sets are in the same tech talk as Hashmaps/Hashtables?</span>
<span class="c1"># hashmaps and hashtables both have unique values; duplicates are removed</span>
<span class="c1">#</span>
</pre></div>
...
<span class="c1"># In this dictionary, there is a list of keys for genres.</span>
<span class="c1"># {dictionary} and [lists]</span>
...
<span class="c1"># printing value at key number 4</span>
</pre></div>
...
<span class="c1"># to make sure there are no duplicate producers, there could be an if loop implemented to get rid of duplicates</span>
<span class="c1"># or, a set could be created so that duplicates are removed</span>
